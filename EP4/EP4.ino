...
const int PIN_LED_EP4 = 5;      // verde, Mega 9
...
void funcao_Ep4(int maxBrilho) {
  ...
  brilhoLED = map(voltageLDR, VALOR_MIN_LUZ, VALOR_MAX_LUZ, MIN_PERC_BRILHO, MAX_PERC_BRILHO);
  if(brilhoLED > MIN_PERC_BRILHO || brilhoLED < MAX_PERC_BRILHO) {
