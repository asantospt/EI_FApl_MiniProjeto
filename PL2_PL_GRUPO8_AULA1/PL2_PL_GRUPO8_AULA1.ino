 ...
 * Pin 49 -> Res. 1 kOhm + (LCD/ DC-RS) + Res. 2 kOhm + '-'       
 * Pin 50 -> LCD/ MISO-SD0                                       
 * Pin 51 -> Res. 1 kOhm + (LCD/ MOSI-SDI) + Res. 2 kOhm + '-'                                   
 * Pin 52 -> Res. 1 kOhm + (LCD/ SCK) + Res. 2 kOhm + '-'         
 * Pin 53 -> Res. 1 kOhm + (LCD/ CS) + Res. 2 kOhm + '-'          
 *
